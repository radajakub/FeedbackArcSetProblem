...
APP_SRCS=$(SRC_DIR)/$(APP_DIR)/solve.cpp $(SRC_DIR)/$(APP_DIR)/graph.cpp $(SRC_DIR)/$(APP_DIR)/state.cpp $(SRC_DIR)/$(APP_DIR)/utils.cpp $(SRC_DIR)/$(APP_DIR)/builders.cpp $(SRC_DIR)/$(APP_DIR)/modifiers.cpp
